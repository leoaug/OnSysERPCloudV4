...
public class UsuarioModuloAdmSession extends BasicSessionBean {
    
    private String jpqlCount = " ";  
    
    public List<UsuarioModulo> getAll() {
        return getList(UsuarioModulo.class,"select a "
                + "from UsuarioModulo a ");
    }

    public List<UsuarioModulo> getAllByUsuarioAdmin(Usuario usuario) {
        return getList(UsuarioModulo.class,"select a "
                + "from UsuarioModulo a "
    ...
    public UsuarioModulo getUsuarioModuloAdmin(int idUsr, int idMod) {
        return getUltPojo(UsuarioModulo.class,"select usrmodulo "
                ...
                + "and usr.id = ?1 and modulo.id = ?2",1 , idUsr, idMod);
    }   
    ...
    public UsuarioModulo getUsuarioModulo(int idEmpresa, int idUsr, int idMod) {
        return getPojo(UsuarioModulo.class,"select usrmodulo "
                ...
                + "and usrmodulo.usuario   = usr    "
                + "and usrmodulo.modulo    = modulo "
                + "and emp.id = ?1 and usr.id = ?2 and modulo.id = ?3",idEmpresa, idUsr, idMod);
    }
