...
@Entity
@Table
public class ComissaoTpMov implements Serializable {
    private static final long serialVersionUID = 1L;

    @OneToMany(mappedBy="comissaotpmov")
    @Id
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ComissaoTpMov)) {
            return false;
        }
        ComissaoTpMov other = (ComissaoTpMov) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.ComissaoTpMov[id=" + id + "]";
    }
}