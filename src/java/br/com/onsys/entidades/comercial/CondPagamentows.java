...
public class CondPagamentows implements Serializable {
    ...
    @OneToMany(mappedBy="condpagamentows")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CondPagamentows)) {
            return false;
        }
        CondPagamentows other = (CondPagamentows) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.CondPagamentows[id=" + id + "]";
    }
