...
// TABELA PARA COMISSÃO DE SUPERVISOR
@Entity
@Table
public class MetaPremio implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MetaPremio)) {
            return false;
        }
        MetaPremio other = (MetaPremio) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.MetaPremio[id=" + id + "]";
    }
