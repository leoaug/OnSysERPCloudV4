...
@Entity
@Table
public class TabRentabilidade implements Serializable {
    ...
    @OneToMany(mappedBy="tabrentabilidade")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TabRentabilidade)) {
            return false;
        }
        TabRentabilidade other = (TabRentabilidade) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.TabRentabilidade[id=" + id + "]";
    }
