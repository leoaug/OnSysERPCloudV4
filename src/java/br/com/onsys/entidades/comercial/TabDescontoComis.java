...
@Entity
@Table
public class TabDescontoComis implements Serializable {
    ...
    @OneToMany(mappedBy="tabdescontocomissao")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TabDescontoComis)) {
            return false;
        }
        TabDescontoComis other = (TabDescontoComis) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.TabDescontoComis[id=" + id + "]";
    }
