...
@Entity
@Table
public class OcorrenciaMotivo implements Serializable {
    ...
    @OneToMany(mappedBy="ocorrenciamotivo")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OcorrenciaMotivo)) {
            return false;
        }
        OcorrenciaMotivo other = (OcorrenciaMotivo) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.OcorrenciaMotivo[id=" + id + "]";
    }
