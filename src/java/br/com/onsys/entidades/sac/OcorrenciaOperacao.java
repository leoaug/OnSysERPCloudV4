...
@Entity
@Table
public class OcorrenciaOperacao implements Serializable {
    ...
    @OneToMany(mappedBy="ocorrenciaoperacao")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OcorrenciaOperacao)) {
            return false;
        }
        OcorrenciaOperacao other = (OcorrenciaOperacao) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.comercial.OcorrenciaOperacao[id=" + id + "]";
    }
