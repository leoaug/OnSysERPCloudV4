...
public class Recurso implements Serializable {
    ...
    @OneToMany(cascade= CascadeType.PERSIST,mappedBy="recurso")
    ...
    public BigDecimal getValorhh() {
        return valorhh;
    }

    public void setValorhh(BigDecimal valorhh) {
        this.valorhh = valorhh;
    }
    ...
    public String toString() {
        return "br.com.onsys.entidades.projetos.Recurso[id=" + id + "]";
    }
