...
@Entity
//@Table
public class FreteFaixasPesoOrdenado implements Comparable<FreteFaixasPesoOrdenado>{
//public class FreteFaixasPeso implements Serializable{  
    
    @OneToMany(mappedBy="freteFaixasPesoOrdenado")    
    ...
    @Override
    public int compareTo(FreteFaixasPesoOrdenado o) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FreteFaixasPesoOrdenado)) {
            return false;
        }
        FreteFaixasPesoOrdenado other = (FreteFaixasPesoOrdenado) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.logistica.FreteFaixasPesoOrdenado[id=" + id + "]";
    }
