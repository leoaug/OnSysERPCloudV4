...
@Entity
@Table
public class SPEDContribReceita implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SPEDContribReceita)) {
            return false;
        }
        SPEDContribReceita other = (SPEDContribReceita) object;
    ...
    public String toString() {
        return "br.com.onsys.entidades.logistica.SPEDContribReceita[id=" + id + "]";
    }
