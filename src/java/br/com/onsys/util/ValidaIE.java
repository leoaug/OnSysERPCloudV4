...
public class ValidaIE {
    ...
    public void valida(String inscricaoEstadual, String siglaUf) throws Exception{
        
        System.out.println("ValidaIE===>valida");
    ...
    private static void validaIEAcre(String ie) throws Exception { //inic&#65533;o do validaIEAcre()
        ...
        if (ie.length() != 13){
            FacesMessage fm = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Atenção :","Quantidade de digitos inválida.");
            FacesContext.getCurrentInstance().addMessage("Quantidade de digitos inválida.", fm);  
            // throw new Exception("");
        }
...
//                throw new Exception("Quantidade de digitos inválidas.");
        ...
        if(ie.length() == 12){
                ...
                if(!ie.substring(8, 9).equals(d1 + "")){
                    FacesMessage fm = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Atenção :","Inscrição estadual inválida.");
                    FacesContext.getCurrentInstance().addMessage("Inscrição estadual inválida.", fm);  
                    //throw new Exception("Inscrição estadual inválida.");
                }
