...
@FacesConverter(value="empresaNomeFantasiaConverter")
public class EmpresaNomeFantasiaConverter  extends ManualCDILookup implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value != null && !" ".equals(value)) {
            ...
            try {
                ...
                Logger.getLogger(EmpresaNomeFantasiaConverter.class.getName()).log(Level.SEVERE, null, ex);
            }
            Empresa empresa = bean.getByNomeFantasia(value);
            return empresa;
        }
        return null;
    }
